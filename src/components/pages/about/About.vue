    ...
    <v-parallax :src="`/pictures/work${Math.round(Math.random() * 4 + 1)}.jpg`" height="100%">
        <div class="d-flex justify-center">
            <v-card class="cardColor ma-2 ma-sm-8 pa-2 px-sm-12 text-h3 wsspan font-weight-medium">
                ...
                <p class="my-4 text-body-1 text-lg-h4">Общество с ограниченной ответственностью «ЭГЕОН» является молодой и перспективно развивающейся компанией,
                    ведущей свою деятельность с 2020 года.</p>
                <p class="my-4 text-body-1 text-lg-h4">Мы ориентированы на удовлетворение спроса широкого круга Заказчиков от крупных нефтегазовых компаний до
                частных потребителей.</p>
                <p class="my-4 text-body-1 text-lg-h4">Приоритетом нашей компании является обеспечение гарантий надежности во всех аспектах сотрудничества.
                ...
                «ЭГЕОН».</p>
                <p class="my-4 text-body-1 text-lg-h4">Наша компания всегда открыта для диалога с существующими и потенциальными Заказчиками. Мы оперативно
